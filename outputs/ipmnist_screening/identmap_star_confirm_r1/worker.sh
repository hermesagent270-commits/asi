...
cfg="$1"
seed="$2"
out="outputs/ipmnist_screening/identmap_star_confirm_r1/shards/${cfg}_seed${seed}.json"
log="outputs/ipmnist_screening/identmap_star_confirm_r1/logs/${cfg}_seed${seed}.log"
if [ -f "$out" ]; then
